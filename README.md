...
buildscript {
    repositories {
        maven { url 'https://raw.githubusercontent.com/nonwithered/SweetChips-repo/v0.0.7' }
    }
}
allprojects {
    repositories {
...
<repositories>
    <repository>
        ...
        <url>https://raw.githubusercontent.com/nonwithered/SweetChips-repo/v0.0.7</url>
    </repository>
</repositories>
<pluginRepositories>
    <pluginRepository>
...
``` bash
git clone -b v0.0.7 git@github.com:nonwithered/SweetChips-repo.git
```
