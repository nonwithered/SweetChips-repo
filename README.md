...
buildscript {
    repositories {
        maven { url 'https://raw.githubusercontent.com/nonwithered/SweetChips-repo/v0.0.5' }
    }
}
allprojects {
    repositories {
...
<repositories>
    <repository>
        ...
        <url>https://raw.githubusercontent.com/nonwithered/SweetChips-repo/v0.0.5</url>
    </repository>
</repositories>
<pluginRepositories>
    <pluginRepository>
...
``` bash
git clone -b v0.0.5 git@github.com:nonwithered/SweetChips-repo.git
```
